...
def get_major_data():
    data = pd.read_csv(r"../../sample/major_sample.csv")
    return data
...
if __name__ == '__main__':
    ...
    pipeline = Pipeline([
        ('mapper', DataFrameMapper([
            ('name', TfidfVectorizer(norm=None, analyzer="word", max_features=1000, stop_words="english")),
    ...
    joblib.dump(pipeline, "../../model/model_for_major_second.joblib")
